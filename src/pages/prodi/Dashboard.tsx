...
const ProdiDashboard: React.FC = () => {
  ...
  const [portfolios, setPortfolios] = useState([
    { nama: 'Veri Kopling', nim: '2200016077', email: 'ver17@gmail.com', major: 'Sistem Informasi', status: 'Active' },
    { nama: 'Ojan Brembo', nim: '2200016078', email: 'Ojan06@gmail.com', major: 'Matematika', status: 'Active' },
    { nama: 'Alex Balap', nim: '2200016089', email: 'Alex05@gmail.com', major: 'Matematika', status: 'Active' },
    { nama: 'Aurion racing', nim: '2200016089', email: 'Alex05@gmail.com', major: 'Matematika', status: 'Active' },
    { nama: 'Oba rajin sholat', nim: '2200016089', email: 'Alex05@gmail.com', major: 'Matematika', status: 'Active' },
    { nama: 'fauzan kartu', nim: '2200016078', email: 'Ojan06@gmail.com', major: 'Matematika', status: 'Active' },
  ]);
        ...
        <div className="bg-white p-6 rounded-xl shadow">
          ...
          <div className="overflow-auto">
            <table className="w-full text-sm text-left text-gray-600">
              ...
              <tbody>
                {(showAll ? portfolios : students).map((student, index) => (
                  <tr key={index} className="bg-white border-b hover:bg-gray-50">
                    <td className="px-4 py-2">{student.name || student.nama}</td>
          ...
          <div className="mt-4">
            <button
              ...
              className="bg-cyan-600 text-white px-4 py-2 rounded-md text-sm hover:bg-cyan-700 transition"
            >
